		...
		<div class="wrap">
			...
			<div class="list-all-product">
				<?php
					...
					$sql="select * from san_pham where ma_danh_muc='$_GET[category]' AND ma_hang='$_GET[id]'";
					...
					<div class="pagination">
						<?php for($i = 1; $i <= $so_trang;$i++){ ?>
							<?php if($i != $trang_hien_tai ){ ?>
									<a href="?category=<?php echo $_GET['category'] ?>&id=<?php echo $_GET['id'] ?>&page=<?php echo $i ?>"><button class="so active"><?php echo $i; ?></button></a>
								<?php }else{ ?>
				...
				<div class="show-all-product">
					<?php
						while($row_cat_bra_product = mysqli_fetch_array($array)){
							$gia_ban = ($row_cat_bra_product['gia'] - ($row_cat_bra_product['gia'] * $row_cat_bra_product['sales']));
							$gia_fm = number_format($row_cat_bra_product['gia'],"0",",",".")." "."₫";
							$gia_banfm = number_format($gia_ban,"0",",",".")." "."₫";
							$sales = ($row_cat_bra_product['sales'] * 100)."%";
					?>
					<div class="box-bottom box-content-bottom">
						<a href="">
							<div class="view view-fifth">
						  	  <div class="top_box">
							  	<h3 class="text_3"><?php echo $row_cat_bra_product['ten_san_pham'] ?></h3>
							  	<p class="text_2">Lorem ipsum</p>
						         	<div class="grid_img">
									   	<div class="imgs">
									   		<img src="admin/modules/product_details/uploads_product/<?php echo $row_cat_bra_product['anh'] ?>" width="170px" height="170px"  alt=""/>
									   	</div>
									   	<a href="view_product_detail.php?ma=<?php echo $row_cat_bra_product['ma_san_pham'] ?>">
								          	<div class="mask1">
				                       			<div class="info1">
				                       				Quick View
				                       			</div>
		                      		...
		                      		<?php 
		                      		if($row_cat_bra_product['sales'] > 0){
		                      		...
		                      		<?php if($row_cat_bra_product['tinh_trang'] == 0){ ?>
							  	...
							  	<li>
							  		...
							  		<ul class="icon1 sub-icon1 profile_img">
								  		<li>
								  			...
								  			<?php }else{ ?>
								  				<?php if($row_cat_bra_product['tinh_trang'] == 1){ ?>
													<a class="active-icon c1" href="add_cart1.php?ma=<?php echo $row_cat_bra_product["ma_san_pham"] ?>" onclick="return alert('Bạn đã thêm sản phẩm vào giỏ hàng');">Add To Bag </a>
												<?php }else{ ?>
